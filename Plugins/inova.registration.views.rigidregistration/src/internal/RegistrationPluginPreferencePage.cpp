...
RegistrationPluginPreferencePage::RegistrationPluginPreferencePage(QWidget*, Qt::WindowFlags)
...
void RegistrationPluginPreferencePage::updateNumberOfLevels(uint numberOfLevels)
{
