...
public:
    ...
    void resize_ShrinkFactorsPerLevel(int numberOfLevels);
    void resize_SmoothingSigmasPerLevel(int numberOfLevels);
    void updateNumberOfLevels(uint numberOfLevels);
