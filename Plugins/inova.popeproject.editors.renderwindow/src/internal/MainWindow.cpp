...
void MainWindow::updateCrosshair(bool is_autorotation_enabled)
{
    ...
    mitk::DataNode* n;
    n = multiWidget->GetWidgetPlane1();
    if (n) n->SetVisibility(is_crosshair_visible);
    n = multiWidget->GetWidgetPlane2();
    if (n) n->SetVisibility(is_crosshair_visible);
    n = multiWidget->GetWidgetPlane3();
    if (n) n->SetVisibility(is_crosshair_visible);
}
...
void MainWindow::On_ToolsPlugin_UpdateCrosshair(const ctkEvent&)
{
...
void MainWindow::On_RegistrationPlugin_GonnaAddNewDataNode(const ctkEvent&)
{
    On_DataManager_GonnaAddNewDataNode();
}
void MainWindow::On_RegistrationPlugin_NewDataNodeAdded(const ctkEvent&)
{
    On_DataManager_NewDataNodeAdded();
}

void MainWindow::on_levelWindow_modified(const itk::EventObject&)
{
