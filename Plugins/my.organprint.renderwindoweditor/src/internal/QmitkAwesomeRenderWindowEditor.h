...
#ifndef QmitkAwesomeRenderWindowEditor_h
#define QmitkAwesomeRenderWindowEditor_h
 ...
 */
class QmitkAwesomeRenderWindowEditor
...
public:
    ...
    // void Log(const std::string &QmitkAwesomeRenderWindowEditor msg);
...
private:
    const QScopedPointer<QmitkAwesomeRenderWindowEditorPrivate> d;

    std::unique_ptr<DataManager> m_DataManager;
};
#endif /*QmitkAwesomeRenderWindowEditor_h*/
