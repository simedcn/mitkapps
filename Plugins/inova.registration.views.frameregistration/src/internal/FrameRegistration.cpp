...
string FrameRegistration::def_algorithm_short_name = "T+A (Mutual Info, MultiRes)"; // "Thiron's demons (Fast, Refined)";
...
void FrameRegistration::OnMapResultIsAvailable(mitk::Image::Pointer spMappedData, const QmitkFramesRegistrationJob* job)
{
	...
	auto original_properties = job->m_spTargetData->GetPropertyList();
