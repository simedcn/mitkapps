...
//	[order]		[id]											[name]									[role]			[title] [position]		[open]
	{ "10",		"org.mitk.views.datamanager",					"Data Manager",							"main",			"yes",	"top_left",			"yes" },
	{ "01",		"inova.popeproject.views.tools",				"POPE View",							"main",			"no",	"right",		"yes" },
	{ "02",		"inova.registration.views.stepselector",		"Registration Selection",				"selector",		"no",	"right",		"yes" },
	{ "09",		"inova.registration.views.rigidregistration",	"Rigid Registration",					"sel_item",		"no",	"bottom",		"no"  },
	{ "03",		"inova.registration.views.manualregistration",	"Manual Registration",					"sel_item",		"no",	"bottom",		"no"  },
...
//	{ "07",		"inova.registration.views.mapper",				"Registration Mapper",					"sel_item",		"no",	"bottom",		"no"  },
	...
	{ "11",		"org.mitk.views.imagenavigator",				"Image Navigator",						"secondary",	"no",	"bottom_left",	"yes" },
	{ "14",		"org.mitk.views.measurement",					"Measurement",							"secondary",	"no",	"bottom_left",	"no"  },
	{ "16",		"org.mitk.views.imagecropper",					"Image Cropper",						"secondary",	"no",	"right",		"no"  },
	{ "12",		"org.mitk.views.properties",					"Properties",							"secondary",	"no",	"mid_left",		"no"  },
	{ "13",		"org.mitk.views.volumevisualization",			"Volume Visualization",					"secondary",	"no",	"mid_left",		"no"  },
	{ "22",		"org.mitk.gui.qt.dicominspector",				"DICOM Inspector",						"secondary",	"no",	"mid_left",		"no"  },
