...
ctkPluginContext* my_pacs_views_dicomview_Activator::PluginContext = nullptr;

void my_pacs_views_dicomview_Activator::start(ctkPluginContext *context)
{
...
void my_pacs_views_dicomview_Activator::stop(ctkPluginContext *context)
{
  Q_UNUSED(context)
...
ctkPluginContext* my_pacs_views_dicomview_Activator::GetPluginContext()
{
