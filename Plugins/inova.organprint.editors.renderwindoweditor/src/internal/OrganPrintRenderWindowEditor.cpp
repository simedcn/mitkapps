...
public:
    ...
    OrganPrintRenderWindowEditorPrivate();
    ~OrganPrintRenderWindowEditorPrivate();
...
{
    QmitkStdMultiWidgetPartListener(OrganPrintRenderWindowEditorPrivate* dd)
        : d(dd)
    {}
    ...
    {
        cout << "OrganPrintWindowRenderPartClosed" << endl;
        if (partRef->GetId() == OrganPrintRenderWindowEditor::EDITOR_ID)
        {
            OrganPrintRenderWindowEditor::Pointer stdMultiWidgetEditor = partRef->GetPart(false).Cast<OrganPrintRenderWindowEditor>();
    ...
    {
        cout << "[OrganPrintWindowRender] " << "PartHidden" << endl;
        if (partRef->GetId() == OrganPrintRenderWindowEditor::EDITOR_ID)
        {
            OrganPrintRenderWindowEditor::Pointer stdMultiWidgetEditor = partRef->GetPart(false).Cast<OrganPrintRenderWindowEditor>();
    ...
    {
        cout << "[OrganPrintWindowRender] " << "PartVisible" << endl;
        if (partRef->GetId() == OrganPrintRenderWindowEditor::EDITOR_ID)
        {
            OrganPrintRenderWindowEditor::Pointer stdMultiWidgetEditor = partRef->GetPart(false).Cast<OrganPrintRenderWindowEditor>();
    ...
    {
        cout << "[OrganPrintWindowRender] " << "PartOpened" << endl;
        if (partRef->GetId() == OrganPrintRenderWindowEditor::EDITOR_ID)
        {
            OrganPrintRenderWindowEditor::Pointer stdMultiWidgetEditor = partRef->GetPart(false).Cast<OrganPrintRenderWindowEditor>();
...
private:
    ...
    OrganPrintRenderWindowEditorPrivate* const d;

};

OrganPrintRenderWindowEditorPrivate::OrganPrintRenderWindowEditorPrivate()
...
const QString OrganPrintRenderWindowEditor::EDITOR_ID = "inova.organprint.editors.renderwindow";

OrganPrintRenderWindowEditor::OrganPrintRenderWindowEditor()
    : d(new OrganPrintRenderWindowEditorPrivate)
{
}

OrganPrintRenderWindowEditor::~OrganPrintRenderWindowEditor()
{
    cout << "[OrganPrintWindowRender] " << "DestroyingRenderWindowEditor" << endl;
    this->GetSite()->GetPage()->RemovePartListener(d->m_PartListener.data());
}

QmitkStdMultiWidget* OrganPrintRenderWindowEditor::GetStdMultiWidget()
{
    cout << "[OrganPrintWindowRender] " << "GetStdMultiWidget" << endl;
    return d->m_StdMultiWidget;
}

QmitkRenderWindow *OrganPrintRenderWindowEditor::GetActiveQmitkRenderWindow() const
{
    cout << "[OrganPrintWindowRender] " << "GetActiveQMitkRenderWindow" << endl;
    if (d->m_StdMultiWidget) return d->m_StdMultiWidget->GetRenderWindow1();
    return 0;
}

QHash<QString, QmitkRenderWindow *> OrganPrintRenderWindowEditor::GetQmitkRenderWindows() const
{
    return d->m_RenderWindows;
}

QmitkRenderWindow *OrganPrintRenderWindowEditor::GetQmitkRenderWindow(const QString &id) const
{
    cout << "[OrganPrintWindowRender] " << "GetMitkRenderWindow" << endl;
...
mitk::Point3D OrganPrintRenderWindowEditor::GetSelectedPosition(const QString & /*id*/) const
{
    //cout << "[OrganPrintWindowRender] " << "GetSelectedPosition" << endl;
    return d->m_StdMultiWidget->GetCrossPosition();
}

void OrganPrintRenderWindowEditor::SetSelectedPosition(const mitk::Point3D &pos, const QString &/*id*/)
{
    cout << "[OrganPrintWindowRender] " << "SetSelectionPositions" << endl;
    d->m_StdMultiWidget->MoveCrossToPosition(pos);
}

void OrganPrintRenderWindowEditor::EnableDecorations(bool enable, const QStringList &decorations)
{
    cout << "[OrganPrintWindowRender] " << "EnableDecorations" << endl;
...
bool OrganPrintRenderWindowEditor::IsDecorationEnabled(const QString &decoration) const
{
    cout << "[OrganPrintWindowRender] " << "IsDecorationEnabled" << endl;
...
QStringList OrganPrintRenderWindowEditor::GetDecorations() const
{
    cout << "[OrganPrintWindowRender] " << "Getting decorations" << endl;
    QStringList decorations;
    decorations << DECORATION_BORDER << DECORATION_LOGO << DECORATION_MENU << DECORATION_BACKGROUND << DECORATION_CORNER_ANNOTATION;
    return decorations;
}

void OrganPrintRenderWindowEditor::EnableSlicingPlanes(bool enable)
{
    cout << "[OrganPrintWindowRender] " << "EnableSlicingPlanes" << endl;
    d->m_StdMultiWidget->SetWidgetPlanesVisibility(enable);
}

bool OrganPrintRenderWindowEditor::IsSlicingPlanesEnabled() const
{
    cout << "[OrganPrintWindowRender] " << "IsSlicingPlanesEnabled" << endl;
...
void OrganPrintRenderWindowEditor::CreateQtPartControl(QWidget* parent)
{
    cout << "[OrganPrintWindowRender] " << "CreateQtPartControl" << endl;
    if (d->m_StdMultiWidget == 0)
    {
        cout << "[OrganPrintWindowRender] " << "d->m_StdMultiWidget == 0" << endl;
...
void OrganPrintRenderWindowEditor::OnPreferencesChanged(const berry::IBerryPreferences* prefs)
{
    cout << "[OrganPrintWindowRender] " << "OnPreferencesChanged" << endl;
...
mitk::Color OrganPrintRenderWindowEditor::HexColorToMitkColor(const QString& widgetColorInHex)
{
    cout << "[OrganPrintWindowRender] " << "HexColorToMitkColor" << endl;
...
QString OrganPrintRenderWindowEditor::MitkColorToHex(const mitk::Color& color)
{
    cout << "[OrganPrintWindowRender] " << "MitkColorToHex" << endl;
    QColor returnColor;
    float colorMax = 255.0f;
...
void OrganPrintRenderWindowEditor::FillMembersWithCurrentDecorations()
{
    cout << "[OrganPrintWindowRender] " << "FillMembersWithCurrentDecorations" << endl;
...
void OrganPrintRenderWindowEditor::GetPreferenceDecorations(const berry::IBerryPreferences * preferences)
{
    cout << "[OrganPrintWindowRender] " << "GetPreferenceDecorations" << endl;
...
void OrganPrintRenderWindowEditor::InitializePreferences(berry::IBerryPreferences * preferences)
{

    cout << "[OrganPrintWindowRender] " << "InitializePreferences" << endl;
...
void OrganPrintRenderWindowEditor::SetFocus()
{
    if (d->m_StdMultiWidget != 0)
        d->m_StdMultiWidget->setFocus();
}

void OrganPrintRenderWindowEditor::RequestActivateMenuWidget(bool on)
{
