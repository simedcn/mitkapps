#ifndef __Q_inova_registration_views_visualizer_H
#define __Q_inova_registration_views_visualizer_H
...
private:
	...
	mitk::ScalarType GetSaveSpacing(mitk::ScalarType gridRes, mitk::ScalarType spacing, unsigned int maxGridRes) const;
