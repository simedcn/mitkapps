...
#include <OrganPrintImageFilter.h>
#include <OrganPrintImageInteractor.h>
...
const std::string OrganPrintView::VIEW_ID = "inova.organprint.views.mainview";

void OrganPrintView::CreateQtPartControl(QWidget* parent)
{
...
OrganPrintView::OrganPrintView() : m_ActiveWorkingNode(nullptr)
{
}

OrganPrintView::~OrganPrintView()
{
    this->m_ServiceRegistration.Unregister();
}

void OrganPrintView::SetFocus()
{

}

void OrganPrintView::SetLabelWidget()
{
...
void OrganPrintView::OnSTLsExportButtonClicked() {
...
void OrganPrintView::OnPushButtonOtsuSegmentationClicked()
{
...
void OrganPrintView::OnColorButtonClicked()
{
    int row = -1;
...
void OrganPrintView::OnVisibleButtonClicked()
{
    int row = -1;
    for (int i = 0; i < m_Controls.m_LabelSetTableWidget->rowCount(); ++i)
    {
...
void OrganPrintView::OnExportButtonClicked()
{
...
void OrganPrintView::OnSelectionChanged(berry::IWorkbenchPart::Pointer, const QList<mitk::DataNode::Pointer>& dataNodes)
{
...
void OrganPrintView::NotifyCoordinates(QVector<double> point)
{
...
void OrganPrintView::enableVolRenderingForCurrentNode(bool volRen)
{
    m_VRNode->SetBoolProperty("volumerendering",volRen);
}

void OrganPrintView::enablePaint()
{
...
void OrganPrintView::NodeRemoved(const mitk::DataNode *node)
{
...
void OrganPrintView::NodeAdded(const mitk::DataNode *node)
{
    bool binary = false;
    ...
    iconVisible->addFile(QString::fromUtf8(":/OrganPrint/visible.png"), QSize(), QIcon::Normal, QIcon::Off);
    iconVisible->addFile(QString::fromUtf8(":/OrganPrint/invisible.png"), QSize(), QIcon::Normal, QIcon::On);
...
mitk::DataNode *OrganPrintView::GetWorkingNode()
{
