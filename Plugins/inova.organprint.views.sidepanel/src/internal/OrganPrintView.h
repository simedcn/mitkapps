...
#ifndef OrganPrintView_h
#define OrganPrintView_h
...
// There's an item "OrganPrintViewControls.ui" in the UI_FILES list in
...
#include <ui_OrganPrintViewControls.h>
...
class OrganPrintView : public QmitkAbstractView
{
...
private:
    ...
    // of our view.
    Ui::OrganPrintViewControls m_Controls;
