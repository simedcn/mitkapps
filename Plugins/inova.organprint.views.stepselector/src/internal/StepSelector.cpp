...
const string StepSelector::VIEW_ID = "inova.organprint.views.stepselector";
...
void StepSelector::CreateQtPartControl(QWidget* parent)
{
    ...
    QFile file(":/inova.organprint.views.stepselector/Styles.qss");
    ...
    m_steps =
    {
        { "inova.organprint.views.importpanel",		ui.pushButton_1 },
        { "org.mitk.views.segmentation",			ui.pushButton_2,true},
        { "inova.organprint.views.tissuepanel",          ui.pushButton_3,true},
        { "inova.organprint.views.exportpanel",        ui.pushButton_4,true }
    };
    ...
    propsForSlot[ctkEventConstants::EVENT_TOPIC] = "inova/organprint/stepselector";
    ctkPluginContext * pluginContext = inova_organprint_views_stepselector_PluginActivator::GetPluginContext();
...
void StepSelector::selectView(int n)
{
    ...
    if(n == 1) {
        displayHelp("inova.organprint.views.stepselector","skipHelpStep2",":/inova.organprint.views.stepselector/step2.html");
    }
...
void StepSelector::OnSelectionChanged(berry::IWorkbenchPart::Pointer, const QList<mitk::DataNode::Pointer>&)
{
    ...
    auto pluginContext = inova_organprint_views_stepselector_PluginActivator::GetPluginContext();
