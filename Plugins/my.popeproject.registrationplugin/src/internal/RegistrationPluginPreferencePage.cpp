...
RegistrationPluginPreferencePage::RegistrationPluginPreferencePage(QWidget* parent, Qt::WindowFlags f)
...
void RegistrationPluginPreferencePage::CreateQtControl(QWidget* parent)
{
	...
	m_RegistrationPluginPreferencesNode = prefService->GetSystemPreferences()->Node("/my.popeproject.views.registrationplugin");
...
void RegistrationPluginPreferencePage::Update()
{
	...
	int percentage = (int)round(100 * m_RegistrationPluginPreferencesNode->GetFloat("samplingPercentage", 0.9f));
...
void RegistrationPluginPreferencePage::resize_ShrinkFactorsPerLevel(int numberOfLevels)
{
...
void RegistrationPluginPreferencePage::resize_SmoothingSigmasPerLevel(int numberOfLevels)
{
...
void RegistrationPluginPreferencePage::updateNumberOfLevels(int numberOfLevels)
{
