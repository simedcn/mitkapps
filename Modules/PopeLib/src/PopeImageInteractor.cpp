...
// macros like we did for the PopeImageFilter.
static void Paint(mitk::Image::Pointer image, itk::Index<3> index, unsigned int timeStep)
{
...
PopeImageInteractor::PopeImageInteractor()
{
}
...
void PopeImageInteractor::ConnectActionsAndFunctions()
{
...
void PopeImageInteractor::DataNodeChanged()
{
...
// read.
void PopeImageInteractor::Paint(mitk::StateMachineAction* /*action*/, mitk::InteractionEvent* event)
{
	try
	{
