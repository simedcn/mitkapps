...
/** \brief Example command line app that demonstrates the pope filter
 *
...
int main(int argc, char *argv[])
{
  ...
  parser.setCategory("Pope Cmd App");
  ...
  try
  {
    ...
    PopeImageFilter::Pointer popeFilter = PopeImageFilter::New();
    popeFilter->SetInput(inImage);
    popeFilter->SetOffset(offset);
    popeFilter->Update();
    mitk::Image::Pointer outImage = dynamic_cast<mitk::Image*>( popeFilter->GetOutput());
